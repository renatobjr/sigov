    ...
    <main class="container-fluid">
        @if(isset($_SESSION['loginSucesso']))
            <div class="alert alert-dismissible alert-success">
                ...
                <strong>SIGov 1.0 </strong><a href="#" class="alert-link">{{ $_SESSION['loginSucesso'] }}</a>
            </div>
        @endif
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet, animi aut consequuntur eos harum laboriosam maxime provident quae quam quas quisquam suscipit vel veritatis. Eos iure iusto neque nulla ratione.
    </main>
</body>
</html>